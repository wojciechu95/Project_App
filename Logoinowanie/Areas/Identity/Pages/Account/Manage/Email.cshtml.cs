...
namespace Logoinowanie.Areas.Identity.Pages.Account.Manage
{
    public partial class EmailModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [EmailAddress(ErrorMessage = "To nie jest adres email. Proszę podaj swój email.")]
        ...
        public async Task<IActionResult> OnPostChangeEmailAsync()
        {
            ...
            if (Input.NewEmail != email)
            {
                ...
                StatusMessage = "Link potwierdzający zmianę e-maila wysłano. Proszę sprawdzić swój e-mail.";
        ...
        public async Task<IActionResult> OnPostSendVerificationEmailAsync()
        {
            ...
            StatusMessage = "Link potwierdzający zmianę e-maila wysłano. Proszę sprawdzić swój email.";
            return RedirectToPage();
        }
    }
}
